...
import 'package:flutter_crud_api_sample_app/API_service.dart';
import 'package:flutter_crud_api_sample_app/profile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.profile == null ? "Input User" : "Update Data",
                    ...
                    onPressed: () {
                      if (_isFieldNameValid == null ||
                        ...
                        _scaffoldState.currentState.showSnackBar(
                          SnackBar(
                            content: Text("Tolong isi semua form yang tersedia"),
                          ),
                        );
                        return;
                      }
                      ...
                      if (widget.profile == null) {
                        _apiService.createProfile(profile).then((isSuccess) {
                          ...
                          if (isSuccess) {
                            ...
                            _scaffoldState.currentState.showSnackBar(SnackBar(
                              content: Text("Pengiriman data anda gagal"),
                            ));
                          }
                        });
                      } else {
                        ...
                        _apiService.updateProfile(profile).then((isSuccess) {
                          ...
                          if (isSuccess) {
                            ...
                            _scaffoldState.currentState.showSnackBar(SnackBar(
                              content: Text("Update data anda gagal"),
                            ));
                          }
                        });
                      }
